...
function HotelCard({ image, name, city, reviewNum, price }: Props) {
    return (
        <div className='cursor-pointer bg-white rounded-md overflow-hidden'>
            <div className='relative overflow-hidden w-[100%] h-[20rem]'>
                <Image src={`${image}`} alt="hotel" className='transform object-cover
                    transition-all duration-700 scale-100 hover:scale-125' layout="fill" />
            </div>
            <div className='p-[1.4rem]'>
                ...
                <div className='w-[100%] opacity-60 h-[0.8px] mt-[1rem] mb-[1rem] bg-gray-800'>
                </div>
                <div className='flex mt-[0.5rem] items-center space-x-3'>
                    <h1 className='border-[2px] rounded-md border-opacity-50 text-blue-700
                        font-bold px-3 py-1 border-blue-500'>
                        5/5
                    </h1>
